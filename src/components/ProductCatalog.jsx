...
const MANUAL_PRODUCTS = [
  ...
  },
  {
    ...
    description: 'Set of 4 slender bangles carved with traditional relief patterns of floral deities, accented with red and green imitation stones in an alternating pattern.',
  ...
  },
  {
    ...
    description: 'An antique gold-plated kada bangle featuring traditional leaf-pattern carvings, studded with rich synthetic emeralds and glass Polki accents.',
  ...
  },
  {
    ...
    description: 'Set of two heavy gold-plated kadas featuring high-relief peacock engravings, studded with synthetic emerald cabochons and flat-cut glass stones.',
  ...
  },
  {
    ...
    description: 'Mughal-inspired long jhumka earrings featuring geometric synthetic sapphire inlays and rows of dangling faux seed pearls.',
  ...
  },
  {
    ...
    description: 'Oversized statement ear studs featuring complex floral glass kundan rings and a central deep red synthetic cabochon ruby surrounded by seed pearls.',
  ...
  },
  {
    id: 'dno_1130',
    code: 'D.no-1130',
    name: 'Royal Watch-Style Kada Bangle',
    description: 'A masterpiece watch-bracelet style kada featuring intricately hand-sculpted gold-colored leaves, set with teardrop synthetic rubies and emeralds.',
  ...
  },
  {
    id: 'dno_1175',
    code: 'D.no-1175',
    name: 'Elephant Motif Temple Kada Bangle',
    description: 'A royal temple-style kada bangle featuring gold-carved elephant figures holding a teardrop synthetic emerald pendant, surrounded by glass kundan.',
  ...
  },
  {
    id: 'dno_2244',
    code: 'D.no-2244',
    name: 'Vaikuntha Deity Temple Kada',
    description: 'A heavy heritage temple kada bangle featuring deity-carved medallions, encrusted with flat-set glass Kundan and emerald beads.',
    image: 'https://images.unsplash.com/photo-1590548784293-85f540b07a16?auto=format&fit=crop&w=600&q=80',
    video: VIDEOS[0],
    category: 'Bangles',
    baseMetal: 'Premium Brass Base',
  ...
  },
  {
    id: 'dno_2247',
    code: 'D.no-2247',
    name: 'Mughal Emerald Polki Kada Bangle',
    description: 'An elegant segmented kada bangle composed of leaf-shaped synthetic emerald structures connected by floral polki-cut kundan glass frames.',
  ...
  },
  {
    id: 'dno_2248',
    code: 'D.no-2248',
    name: 'Thanjavur Guttapusalu Ear Studs',
    description: 'A traditional southern collar ear stud set loaded with dense clusters of tiny clean faux rice pearls and synthetic ruby details.',
    image: 'https://images.unsplash.com/photo-1610970684895-8b065e3ec77c?auto=format&fit=crop&w=600&q=80',
    video: VIDEOS[1],
    category: 'Earrings',
    baseMetal: 'Premium Brass Base',
    goldPlating: 'Micron Gold Plated Finish',
...
const CATEGORIES = ['All', 'Earrings', 'Bangles'];
          ...
          {filteredProducts.map((product) => (
            <div key={product.id} className="product-card">
              ...
              <div className="product-info">
                ...
                <div className="product-spec">
                  <span>Plating/Finish:</span>
                  <span>{product.goldPlating || 'Micron Gold Plated'}</span>
                </div>
                <div className="product-spec">
                  <span>Stones:</span>
